...
export class HeaderComponent implements OnInit {
  ...
  constructor(public menuItems: MenuItems,private HttpRequest:HttpRequestService,private myRoute: Router) {
    this.animateSidebar = '';
    this.navType = 'st2';
  ...
  logout() {
    this.HttpRequest.getRequest('POST', 'ADMIN_LOGOUT', localStorage.getItem("accessToken")).subscribe((data:any)=>{ console.log(data)});
